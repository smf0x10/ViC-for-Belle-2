...
CUDA_VISIBLE_DEVICES=0 PORT=33020 ./tools/dist_test.sh "./configs/belle_2/belle-2-hep2coco-mmt-simple.py" "./work_dirs/belle-2-hep2coco-mmt-simple/epoch_12.pth" 1 --out "./work_dirs/belle-2-hep2coco-mmt-simple/results_ep12.pkl"
